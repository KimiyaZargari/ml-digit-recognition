...
print('labmda = 1: Linear Regression test_error =', run_linear_regression_on_MNIST(lambda_factor=1))
...
print('softmax after projection', test_error)
...
print('softmax for cubic PCA features', test_error)
model = SVC(kernel='rbf', random_state=0)
model.fit(train_pca10, train_y)
pred_test_y = model.predict(test_pca10)
accuracy = accuracy_score(test_y, pred_test_y)
print('rbf test_error:', 1 - accuracy)

model = SVC(kernel='poly', random_state=0)
model.fit(train_cube, train_y)
pred_test_y = model.predict(test_cube)
test_error = compute_test_error_svm(test_y, pred_test_y)
print('poly test_error:', test_error)
